            ...
            <Row align="center">
                <Col lg={8}>
                    <div id="aboutLeftColumn">
                        <h1><span className="mainWords">Discover</span> new Ideas</h1>
                        ...
                        <h1><span className="mainWords">Share</span> your ideas</h1>
                        <div className="description">
                        ...
                        <h1><span className="mainWords">Save</span> your ideas</h1>
                        <div className="description">
